          ...
          >
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-4 md:gap-6 justify-center">
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="bg-[#0B3C5D] text-white px-6 md:px-8 py-4 md:py-5 rounded-full font-bold text-base md:text-lg shadow-2xl flex items-center justify-center gap-3 hover:bg-[#1565C0] transition-all"
              >
            ...
            <div className="mt-12 flex flex-col sm:flex-row flex-wrap gap-6 md:gap-8 justify-center">
              <div className="bg-white/10 backdrop-blur-sm p-5 md:p-6 rounded-2xl border-2 border-white/20">
                <Phone className="h-7 w-7 md:h-8 md:w-8 mb-3 mx-auto" />
                <p className="text-sm md:text-base">24/7 Helpline</p>
                <p className="text-lg md:text-xl">+91 99999 99999</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm p-5 md:p-6 rounded-2xl border-2 border-white/20">
                <Mail className="h-7 w-7 md:h-8 md:w-8 mb-3 mx-auto" />
                <p className="text-sm md:text-base">Email Us</p>
                <p className="text-lg md:text-xl">info@rideplustravels.com</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm p-5 md:p-6 rounded-2xl border-2 border-white/20">
                <MapPin className="h-7 w-7 md:h-8 md:w-8 mb-3 mx-auto" />
                <p className="text-sm md:text-base">Head Office</p>
                <p className="text-lg md:text-xl">Delhi, India</p>
              </div>
            </div>
          </motion.div>
        </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl md:text-2xl" style={{ fontFamily: 'Poppins, sans-serif' }}>
                  RidePlus Travels
                </h3>
              </div>
